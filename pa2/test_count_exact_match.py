...
class test_count_exact_match(unittest.TestCase):
    ...
    def test_count_exact_match_1(self):
        """ #name(Test count_exact_match 1) #score(6)"""
    ...
    def test_count_exact_match_2(self):
        """ #name(Test count_exact_match 2) #score(6)"""
        stu = count_exact_match("snackaverage", "stackoverflow")
        assert_equal_with_message(self, "Test count_exact_match 1", 7, stu)

    @weight(3)
    def test_count_exact_match_3(self):
        """ #name(Test count_exact_match 3) #score(4)"""
        stu = count_exact_match("ABCDE", "ABCDE")
        assert_equal_with_message(self, "Test count_exact_match 1", 5, stu)

    @weight(3)
    def test_count_exact_match_4(self):
        """ #name(Test count_exact_match 4) #score(4)"""
        stu = count_exact_match("  ABCDE  ", "ABCDE")
        assert_equal_with_message(self, "Test count_exact_match 1", 0, stu)

    @weight(2)
    def test_count_exact_match_5(self):
        """ #name(Test count_exact_match 5) #score(3)"""
        stu = count_exact_match("", "alonglongstring")
        assert_equal_with_message(self, "Test count_exact_match 1", 0, stu)

    @weight(2)
    def test_count_exact_match_6(self):
        """ #name(Test count_exact_match 6) #score(3)"""
        stu = count_exact_match("", "")
        assert_equal_with_message(self, "Test count_exact_match 1", 0, stu)

    @weight(2)
    def test_count_exact_match_7(self):
        """ #name(Test count_exact_match 7) #score(3)"""
