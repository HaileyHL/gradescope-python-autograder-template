...
class test_validate_email(unittest.TestCase):
    ...
    def test_validate_email1(self):
        ...
        expected = True
        self.assert_equal_with_message("Test valid email 1", expected, stu)

    @weight(4)
    def test_validate_email2(self):
        stu = validate_email("abcgmail.com", "gmail.com")
        expected = False
        self.assert_equal_with_message("Test invalid email 2", expected, stu)

    @weight(3)
    def test_validate_email3(self):
        stu = validate_email("abc@@gmail.com", "gmail.com")
        expected = False
        self.assert_equal_with_message("Test invalid email 3", expected, stu)

    @weight(3)
    def test_validate_email4(self):
        stu = validate_email("abc@:^).com", ":^).com")
        expected = True
        self.assert_equal_with_message("Test weird suffix", expected, stu)

    @weight(3)
    def test_validate_email5(self):
        stu = validate_email("       abc@gmail.com", "gmail.com")
        expected = True
        self.assert_equal_with_message("Test leading spaces 5", expected, stu)

    @weight(3)
    def test_validate_email6(self):
        stu = validate_email("abc@gmail.com       ", "gmail.com")
        expected = True
        self.assert_equal_with_message("Test trailing spaces", expected, stu)

    @weight(3)
    def test_validate_email7(self):
        stu = validate_email("       abc@gmail.com       ", "gmail.com")
        expected = True
        self.assert_equal_with_message("Test both spaces 7", expected, stu)

    @weight(3)
    def test_validate_email8(self):
        stu = validate_email("ab c@gmail.com", "gmail.com")
        expected = False
        self.assert_equal_with_message("Test spaces in the middle 8", expected, stu)

    @weight(3)
    def test_validate_email9(self):
        stu = validate_email("abc@g mail.com", "gmail.com")
        expected = False
        self.assert_equal_with_message("Test spaces in the middle 9", expected, stu)

    @weight(3)
    def test_validate_email10(self):
        stu = validate_email("abc@gmail.com", "ucsd.edu")
        expected = False
        self.assert_equal_with_message("Test wrong suffix 10", expected, stu)
