...
class test_dining_hall_menus(unittest.TestCase):
    ...
    def test_dining_hall_menus_2(self):
        ...
        assert_equal_with_message(self, "Test normal case 2", sorted(expected_list), sorted(stu))

    @weight(5)
    def test_dining_hall_menus_3(self):
        stu = dining_hall_menus(['sushi'], ['fries'])
        expected_list = ['sushi', 'fries']
        assert_equal_with_message(self, "Test normal case 3", sorted(expected_list), sorted(stu))
    ...
    def test_dining_hall_menus_4(self):
        ...
        assert_equal_with_message(self, "Test normal case 4", sorted(expected_list), sorted(stu))

    @weight(4)
    def test_dining_hall_menus_5(self):
        stu = dining_hall_menus(['pizza', 'salad', 'salad'], ['pizza'])
        expected_list = ['salad']
        assert_equal_with_message(self, "Test duplicate case 5", sorted(expected_list), sorted(stu))

    @weight(4)
    def test_dining_hall_menus_6(self):
        stu = dining_hall_menus(['pasta', 'pasta', 'PASTA'], ['pasta'])
        expected_list = ['PASTA']
        assert_equal_with_message(self, "Test duplicate case 6", sorted(expected_list), sorted(stu))

    @weight(3)
    def test_dining_hall_menus_7(self):
        stu = dining_hall_menus([], [])
        expected_list = []
        assert_equal_with_message(self, "Test both empty 7", expected_list, stu)

    @weight(3)
    def test_dining_hall_menus_8(self):
        stu = dining_hall_menus([], ['fries', 'fries'])
        expected_list = ['fries']
        assert_equal_with_message(self, "Test empty case 8", sorted(expected_list), sorted(stu))

    @weight(3)
    def test_dining_hall_menus_9(self):
        stu = dining_hall_menus(['sushi', 'sushi'], ['sushi', 'sushi'])
        expected_list = []
        assert_equal_with_message(self, "Test same menus case 9", expected_list, stu)

    @weight(3)
    def test_dining_hall_menus_10(self):
        stu = dining_hall_menus(['burgers'], [''])
        expected_list = ['burgers', '']
        assert_equal_with_message(self, "Test empty string case 10", sorted(expected_list), sorted(stu))
